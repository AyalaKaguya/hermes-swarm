...
export type LoginAuditScopeType = "platform" | "tenant";

/** Append-only record of a platform or tenant interactive login attempt. */
@Entity({ name: "login_audit_logs" })
@Index("IDX_login_audit_scope", ["scopeType", "createdAt"])
@Index("IDX_login_audit_tenant", ["tenantId", "createdAt"])
