...
export const PAGE_ACCESS_DEFINITIONS = [
  ...
  definePageAccess({
    ...
    label: "日志审计",
    order: 10,
    routePatterns: ["/platform/governance", "/platform/governance/audit"],
    scope: "platform",
  ...
  definePageAccess({
    ...
    label: "工作空间申请",
    order: 5,
    routePatterns: ["/platform", "/platform/workspaces"],
    scope: "platform",
    section: "platform",
    sectionLabel: "平台",
  }),
  definePageAccess({
    defaultRoles: ["platform-admin"],
    description: "允许平台工作人员统一处理各工作空间提交的工单。",
    href: "/platform/governance/tickets",
    icon: "file",
    key: "platform.tickets",
    label: "工单中心",
    order: 20,
    routePatterns: ["/platform/governance/tickets", "/platform/tickets"],
    scope: "platform",
    section: "platform-governance",
    sectionLabel: "平台治理",
  }),
